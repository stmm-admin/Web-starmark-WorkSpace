...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    hero: Schema.Attribute.Component<'hero-video.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    philosophies: Schema.Attribute.Component<'sections.philosophy-card', true>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vision: Schema.Attribute.Component<'sections.vision', false>;
  };
}
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    displayName: 'Category (\u0E2B\u0E21\u0E27\u0E14\u0E2B\u0E21\u0E39\u0E48\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32)';
...
export interface ApiCollectionPageCollectionPage
  ...
  info: {
    description: 'Configuration for the main Collections landing page';
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product collections/series';
    displayName: 'Collection (\u0E0B\u0E35\u0E23\u0E35\u0E2A\u0E4C\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32)';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    displayName: 'Homepage (\u0E2B\u0E19\u0E49\u0E32\u0E41\u0E23\u0E01\u0E2B\u0E25\u0E31\u0E01)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'sections.cta', false>;
    featured: Schema.Attribute.Component<'sections.featured', false>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Mogen Product Items';
    displayName: 'Product (\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32)';
    pluralName: 'products';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downloads: Schema.Attribute.Media<'images' | 'files', true>;
    ...
    trending_topic: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project showcase cards';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Component<'sections.project-tag', true>;
...
export interface ApiProjectsPageProjectsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuration for Projects landing page';
...
export interface ApiTrendingTrending extends Struct.CollectionTypeSchema {
  collectionName: 'trending_1';
  info: {
    displayName: 'TRENDING TOPICS';
    pluralName: 'trending-1';
